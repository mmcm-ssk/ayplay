...
:run
echo Generating pre-calculated waveforms...
"%NODE_EXE%" scripts/generate-waveforms.js
if errorlevel 1 (
    echo Error generating waveforms.
    pause
    exit /b 1
)
echo Done! Waveforms generated successfully.
pause
