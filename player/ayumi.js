...
globalThis.DECIMATE_FACTOR = DECIMATE_FACTOR;
globalThis.FIR_SIZE = FIR_SIZE;
globalThis.DC_FILTER_SIZE = DC_FILTER_SIZE;
...
globalThis.AY_DAC_TABLE = AY_DAC_TABLE;
globalThis.YM_DAC_TABLE = YM_DAC_TABLE;
...
function Ayumi() {
  ...
  this.left = 0.0;
  this.right = 0.0;
  this.chanOut = [{left:0,right:0},{left:0,right:0},{left:0,right:0}];
  this.chanRaw = [0, 0, 0];
...
Ayumi.prototype.updateMixer = function() {
  ...
  for(var i = 0; i < this.channels.length; i++) {
    ...
    var amp = this.dacTable[out];
    this.chanRaw[i] = amp;
    this.chanOut[i].left = amp * this.channels[i].panLeft;
    this.chanOut[i].right = amp * this.channels[i].panRight;
    this.left += this.chanOut[i].left;
    this.right += this.chanOut[i].right;
  }
}
